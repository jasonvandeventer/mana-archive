...
- v3.13.4: Fix empty space in compass/triangle/long-table layouts — remove `.` placeholder cells; Triangle now `"top top" / "l r"`, Compass now `"top top" / "l r" / "bot bot"`, 5/7-player long tables restructured to sides-only (2+2+1 and 3+3+1) with no unassigned grid cells — **committed**
